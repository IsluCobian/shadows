...
export default function Header() {
  return (
    <div className="bg-background fixed inset-x-0 top-0 z-0 m-3 flex items-center rounded-xl border p-4 md:left-1/2 md:m-0 md:mt-3 md:w-80 md:-translate-x-1/2">
